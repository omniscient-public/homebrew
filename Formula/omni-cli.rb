class OmniCli < Formula
  ...
  on_macos do
    on_intel do
      url "https://github.com/omniscient-public/binaries/releases/download/v0.2.26/omni-cli-darwin-amd64.tar.gz"
      sha256 "f2079aca2d781339288cbfea4fdc85ada68af72df2f32077668f2a59ca5dc5e7"
    end
        
    on_arm do
      url "https://github.com/omniscient-public/binaries/releases/download/v0.2.26/omni-cli-darwin-arm64.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/omniscient-public/binaries/releases/download/v0.2.26/omni-cli-linux-amd64.tar.gz"
      sha256 "a24a645b064297f41b25ef3062266981a740a87287ac08e734469aab22ac29b2"
    end
        
    on_arm do
      url "https://github.com/omniscient-public/binaries/releases/download/v0.2.26/omni-cli-linux-arm64.tar.gz"
